...
export type PermissionListFilterProps = {
  filters?: CrudFilters
...
export function PermissionListFilter({
  filters,
  onFiltersChange,
}: PermissionListFilterProps) {
  ...
  const { result: suggestionsResult } = useList<Permission>({
