...
export type PermissionGroupListFilterProps = {
  filters?: CrudFilters
...
export function PermissionGroupListFilter({
  filters,
  onFiltersChange,
}: PermissionGroupListFilterProps) {
  ...
  const { result: suggestionsResult } = useList<PermissionGroup>({
          ...
          <div className="max-h-[280px] overflow-hidden">
            {suggestions.length === 0 && !inputValue.trim() ? (
              <p className="py-4 text-center text-sm text-muted-foreground">
                {t('permissionGroups.typeToSearch')}
              </p>
            ) : (
                ...
                <div className="p-1">
                  ...
                  {inputValue.trim() && (
                    <div className="border-t py-1">
                      ...
                      >
                        {t('permissionGroups.searchByKeyword', {
                          keyword: inputValue,
                        })}
                      </button>
                    </div>
